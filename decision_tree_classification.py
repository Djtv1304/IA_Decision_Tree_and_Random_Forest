...
# Cargando el dataset
dataset = pd.read_csv('Employee_Attrition_Modified.csv')  # Lee el archivo CSV con los datos
...
# ENTROPY: Mide el nivel de desorden o no certeza en un dataset, La antropía ayuda a buscar el orden detro de todo el desorden
